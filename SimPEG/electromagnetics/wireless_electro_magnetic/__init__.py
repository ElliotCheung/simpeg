...
from ..natural_source.fields import Fields1DPrimarySecondary, Fields3DPrimarySecondary
from ..natural_source.simulation import Simulation1DPrimarySecondary, Simulation3DPrimarySecondary
from . import sources
